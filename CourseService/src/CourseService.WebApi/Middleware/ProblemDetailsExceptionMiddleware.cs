namespace CourseService.WebApi.Middleware;
...
public class ProblemDetailsExceptionMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (UserServiceClientException ex)
        {
            _logger.LogError(ex, "API client error calling UserService");
    ...
    private Task WriteApiClientProblemAsync(HttpContext context, UserServiceClientException ex)
    {
